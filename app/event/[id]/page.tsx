...
export default function EventPage({
  ...
  const signatureFormatIsValid = /^0x[0-9a-fA-F]{130}$/.test(trimmedSignature);
  return (
            ...
            <div className="mint-action" role="tabpanel">
              ...
              {tab === "signature" && (
                <div>
                  ...
                  {trimmedSignature && (
                    <p
                      className={signatureFormatIsValid ? "success" : "error"}
                      role="status"
                    >
                      {signatureFormatIsValid
                        ? "Signature format accepted. The contract will verify that it was issued for this wallet."
